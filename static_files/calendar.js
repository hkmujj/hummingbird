...
function checkDate_delta(oDate,delta)
{
  var arr1=oDate.value.split("-");
//  var m1=parseInt(arr1[0]*12)+parseInt(arr1[1]);
  var m1 = parseInt(arr1[0]+arr1[1]);
  var m2 = parseInt(m1/100)*12+m1%100;
  var mNow=parseInt((new Date().getFullYear())*12)+ parseInt((new Date().getMonth()+ 1));
//  alert(m2);
//  alert(mNow);
//  alert(m2+5);
//  alert(m2+5<mNow);
  ...
  { 
//    alert(arr1[0]+arr1[1]);
//    alert(parseInt(arr1[0]+arr1[1]));    
//    alert(m1);
//    alert(mNow);
    alert("很抱歉,只能查询最近6个月记录.");
    oDate.focus();
    oDate.select();
    return false;
  }
...
function MM_initTimelines() { //v4.0
    ...
    if (ns4)
        document.MM_Time[0][1].obj = document["Layer7"];
    else if (ns5)
        document.MM_Time[0][1].obj = document.getElementById("Layer7");
    else
        document.MM_Time[0][1].obj = document.all ? document.all["Layer7"] : null;
    document.MM_Time[0][1].keyFrames = new Array(1, 25);
    document.MM_Time[0][1].values = new Array(3);
    if (ns5)
        document.MM_Time[0][1].values[0] = new Array("17px", "48px", "80px", "111px", "143px", "174px", "206px", "237px", "269px", "300px", "332px", "363px", "395px", "426px", "457px", "489px", "520px", "552px", "583px", "615px", "646px", "678px", "709px", "741px", "772px");
    else
        document.MM_Time[0][1].values[0] = new Array(17,48,80,111,143,174,206,237,269,300,332,363,395,426,457,489,520,552,583,615,646,678,709,741,772);
    document.MM_Time[0][1].values[0].prop = "left";
    if (ns5)
        document.MM_Time[0][1].values[1] = new Array("460px", "460px", "459px", "459px", "458px", "458px", "457px", "457px", "456px", "456px", "455px", "455px", "455px", "454px", "454px", "453px", "453px", "452px", "452px", "451px", "451px", "450px", "450px", "449px", "449px");
    else
        document.MM_Time[0][1].values[1] = new Array(460,460,459,459,458,458,457,457,456,456,455,455,455,454,454,453,453,452,452,451,451,450,450,449,449);
    ...
    if (ns5)
        document.MM_Time[0][1].values[2] = new Array("206px", "205px", "205px", "205px", "205px", "204px", "204px", "204px", "204px", "204px", "203px", "203px", "203px", "203px", "203px", "202px", "202px", "202px", "202px", "202px", "201px", "201px", "201px", "201px", "201px");
    else
        document.MM_Time[0][1].values[2] = new Array(206,205,205,205,205,204,204,204,204,204,203,203,203,203,203,202,202,202,202,202,201,201,201,201,201);
