...
select 'AREA' area, a.mkt_channel_name, b._4M, a.total, b._4M*1.0/a.total rate from 
(
select b.mkt_channel_name, count(*) total from ds_chn_prd_serv_mkt_AREA_{yyyymm} a
...
and a.serv_num=1
and b.mkt_area_id='AREA'
group by b.mkt_channel_name
) a
left join 
(select 
--down_velocity, 
b.mkt_channel_name, count(*) _4M from ds_chn_prd_serv_AREA_{yyyymm} a
--left join dim_zone_comm b on a.com_grid_id=b.com_grid_id
left join dim_zone_area b on a.mkt_grid_id=b.mkt_grid_id
where a.PRODUCT_ID in (
--102010002 --ADSL专线
...
and b.mkt_area_id='AREA'
group by 1
) b on a.mkt_channel_name=b.mkt_channel_name
