...
--吴晓群发模板.
--from dm_evt_sr_accept t1                                                ---受理工单表
---left join DIM_CRM_STAFF t2 on t1.OPER_ID=t2.PARTY_ROLE_ID               ---员工表                   
--left join DIM_CRM_ORGANIZATION t3 on t1.depart_id=t3.party_id     ----组织
--left join DIM_LOV_CONFIG t4 on t1.ACCEPT_METHOD=t4.lov_code       ----
--left join DM_EVT_AL_PROMOTION t5 on t1.serv_id=t5.serv_id         ---业务促销信息 
--left join DIM_CRM_C_PROMOTION t6 on t5.promotion_id=t6.promotion_id    ---促销人 
--left join DIM_CRM_SERVICE_OFFER t7 on t1.service_id=t7.service_offer_id    ----服务提供静态表
