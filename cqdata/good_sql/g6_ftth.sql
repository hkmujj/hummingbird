...
select distinct acc_nbr 用户电话号码, user_name 用户名称, prod_addr 用户地址, a.state 用户状态, serv_state 设备状态, down_velocity 下行带宽, serv_num 到达标记, mkt_cust_code 合同号, mdf_code 配线架编码, jjx_code 交接箱编码, fxh_code 分线盒编码, com.com_channel_name 维护营维部, com.com_grid_name 维护网格, pro.product_name 四级产品名称
...
from 
ds_chn_prd_serv_com_AREA_{yyyymm} a
left join 
 DM_EVT_ALL_SERV_ACCESS_MODE_{yyyymm} b on a.serv_id=b.prodinscode
