...
select serv_id, acc_nbr, user_name, billing_mode_id, completed_date,cdma_card_flag, offln_flg, owe_offln_flag, due_offln_flag, owe_monshts, zero_flag, remove_flag, use_state from ds_chn_prd_serv_com_AREA_FEEMONTH where serv_id in  
